...
const GEO_PROVIDERS = {
  amap: {
    name: 'AMap',
    url: 'https://restapi.amap.com/v3/geocode/regeo?key=b97ac198ff5f7bac333482e20c1a82d7',
    convertUrl: 'https://restapi.amap.com/v3/assistant/coordinate/convert?coordsys=gps&output=json&key=b97ac198ff5f7bac333482e20c1a82d7'
  },
  bigdatacloud: {
    name: 'BigDataCloud',
...
/* Alert banner */
  ...
  _ensureTileLayer(L) {
    ...
    this._tileLayer = theme === 'dark'
      ? L.tileLayer('https://basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png?key=cb1_2a9o_1_f464969b1975248982396de0', {
          attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> © <a href="https://carto.com/attributions">CARTO</a>',
          maxZoom: 19,
          keepBuffer: 6,
        })
      : L.tileLayer('https://basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png?key=cb1_2a9o_1_f464969b1975248982396de0', {
          attribution: '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> © <a href="https://carto.com/attributions">CARTO</a>',
          maxZoom: 19,
          keepBuffer: 6,
        });
...
async _reverseGeocode(lat, lng) {
  ...
  if (provider.convertUrl) {
    try {
      const convertUrl = `${provider.convertUrl}&locations=${lng},${lat}`;
  ...
  if (providerKey === 'amap') {
    const url = `${base}${sep}location=${useLng},${useLat}&extensions=all&roadlevel=1&radius=300&output=json`;
    try {
